...
create new file (FP) that has twenty lines each with twenty tokens. make sure that there a animals, integers, and doubles as the tokena
...
public class FinalProject {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        do { //because this is a do while loop, we can ask the user if they want to play again, and again, an infinite amount of times
            File file = new File("C:\\Users\\rcwet\\IdeaProjects\\Myfirstproject\\src\\FP.txt"); //this is for the file that we used
            ...
            if (startresponse.equals("yes")) {
                ...
                if (answer.contains("w")) { //if the answer contains w, then the program prints out "Cool!" and tells the user that the catorgory is anmals
                    System.out.println("Cool! The category for words is animals. Guess an animal.");
                    answer = " ";
    ...
    public static double doubly(double ogdouble, Scanner sc, int count) { //this whole method is to find out if the user got it right or wrong
        ...
        while (sc.hasNextLine()) {
            if (sc.hasNextDouble()) {
                ...
                if (sc.nextDouble() == (ogdouble)){ //if the user guesses correctly (their answer equals a double in the file) then it prints out "Congrats!" and adds a point to their total
    ...
    public static int integery(int oginteger, Scanner sc, int count) {
        ...
        while (sc.hasNextLine()) {
            if (sc.hasNextInt()) {
                if (sc.nextInt() == (oginteger)) { //if the user guesses correctly (their answer equals a int in the file) then it prints out "Congrats!" and adds a point to their total
    ...
    public static int wordy(String ogword, Scanner sc, int count) {
        ...
        while (sc.hasNextLine()) {
            if (sc.hasNext()) {
                if (sc.next().equals(ogword)){ //if the user guesses correctly (their answer equals an animal in the file) then it prints out "Congrats!" and adds a point to their total
    ...
    public static void bye(){
        System.out.println("                               -----------"); //this is entirely extra credit
        System.out.println("  /^\\    __________     [>-<] <| Adios!  | ");
